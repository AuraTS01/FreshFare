            ...
            <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p>Fresh Fare (“Company,” “we,” “our,” or “us”) is committed to protecting the privacy of our customers.
                        ...
                        📧 Email: support@freshfare.in<br>
                        📞 Phone: +91 - 90422 81069</p>
            ...
            <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p>Fresh Fare (“Company,” “we,” “our,” or “us”) is committed to providing safe, timely, and reliable delivery of fresh meats to our customers. This Delivery Information Policy outlines our practices regarding order fulfillment, delivery, and related information.</p>
            ...
            <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p>Fresh Fare (“Company,” “we,” “our,” or “us”) is committed to providing a safe and secure shopping experience for all our customers. This Secure Shopping Policy explains the measures we take to protect your personal and payment information when using our website or app.</p>
        ...
        function renderOrders() {
            ...
            pageOrders.forEach(order => {
                ...
                order.items.forEach(it => {
                    itemsHtml += `<li>${it.item_name} (${parseFloat(it.quantity)} ${it.unit}) – ₹${parseFloat(it.price).toFixed(2)}</li>`;
                });
                itemsHtml += "</ul>";
                ...
                if (orders.length === 0) {
                    ...
                    orders.forEach(order => {
                        ...
                        order.items.forEach(it => {
                            itemsHtml += `
                                <li>
                                    ${it.item_name} (${parseFloat(it.quantity)} ${it.unit}) – ₹${parseFloat(it.price).toFixed(2)}
